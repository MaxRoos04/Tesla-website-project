  ...
  return (
    <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
        ...
        className='flex-1'>
          ...
          <h3 className='h4 mb-4 text-gray font-secondary unbold'>Supercharger charging stations are located on major routes near services and keep your battery charged while you're on the go.</h3>
          <p className='mb-6'></p>
